...
\begin{table}[htbp]
\centering
\caption{End-to-End Ablation: Decoding Throughput Across Five Stages}
\label{tab:ablation_summary}
\setlength{\tabcolsep}{2.5pt}
\scriptsize
\begin{tabular}{lccccc}
\toprule
\textbf{Stage} & \textbf{tok/s} & \textbf{Incr.} & \textbf{Cumul.} & \textbf{WikiText-2 PPL} & \textbf{Key Mechanism} \\
\midrule
1. FP32 Baseline & 14.9 & --- & 1.00$\times$ & 13.20 (FP16 ref.) & --- \\
2. Naive INT8 & 16.1 & 1.08$\times$ & 1.08$\times$ & 13.22 (+0.02) & Data reduction \\
3. Warp-Opt INT8 & 31.8 & 1.98$\times$ & 2.13$\times$ & 13.22 (+0.02) & Coalesced access \\
4. + Fused Ops & 30.0 & $<$1$\times$ & 2.01$\times$ & 13.22 (+0.02) & Kernel fusion \\
5. + Fused Attn & 35.2 & 1.13$\times$ & 2.36$\times$ & 13.22 (+0.02) & Launch reduction \\
6. + dp4a W8A8 & \textbf{44.0} & \textbf{1.25}$\times$ & \textbf{2.95}$\times$ & \textbf{13.36 (+0.16)} & INT8 SIMD \\
\bottomrule
\end{tabular}
\end{table}
